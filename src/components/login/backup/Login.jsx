// Login.jsx — Material UI v5 + react-hook-form (Controller)
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (esValido) {
        ...
        setErrorMsg('Los datos ingresados son incorrectos. Verifica tu DNI.');
      }
    } catch (error) {
                ...
                <OutlinedInput
                  ...
                  startAdornment={
                    <InputAdornment position="start">
                      ...
                      >
                        <EmailRounded sx={{ color: '#fff', fontSize: 20 }} />
                      </Box>
                    </InputAdornment>
                  }
                  sx={{ borderRadius: 2, fontSize: '1rem', minHeight: 64 }}
                />
                {errors.username && (
                ...
                <OutlinedInput
                  ...
                  startAdornment={
                    <InputAdornment position="start">
                      ...
                      >
                        <LockRounded sx={{ color: '#fff', fontSize: 20 }} />
                      </Box>
                    </InputAdornment>
                  }
                  endAdornment={
